...
-- ==========================================
-- PROTEÇÕES PARA DELTA EXECUTOR - LagTeck
-- ==========================================
...
local Window = OrionLib:MakeWindow({Name = "LagTeck", HidePremium = false, IntroText = "LagTeck V1", SaveConfig = true, ConfigFolder = "LagTeck"})

OrionLib:MakeNotification({
	Name = "Lag Teck",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://134586849523908",
	Time = 7
})
...
local W = Window:MakeTab({
    Name = "Welcome",
    Icon = "rbxassetid://134586849523908",
    PremiumOnly = false
})
...
W:AddLabel("[+] LagTeck está aqui!")
W:AddLabel("[+] Melhor AutoFarm!")
W:AddLabel("[+] Sempre Evoluindo")
W:AddLabel("[+] Suave e Rápido")
